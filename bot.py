        ...
        messages=[
            {
                "role": "system",
                "content": (
                   "Ты эксперт по питанию. Определи блюдо на фото и разбей его "
"на ингредиенты с калорийностью каждого.\n\n"
"Ответ дай СТРОГО в формате:\n\n"
"🍽 Название блюда — XXX ккал\n"
"• Ингредиент — XX ккал\n"
"• Ингредиент — XX ккал\n"
"• Ингредиент — XX ккал\n\n"
"ИТОГО: XXX ккал\n\n"
"Без объяснений, без диапазонов, без текста."
                )
            },
            {
                "role": "user",
